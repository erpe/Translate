...
Tab {
    ...
    title: i18n.tr("String Translation")
    ...
    page: Page {
        Item {
            ...
            TextField {
                ...
                placeholderText: "Phrase or String"
                hasClearButton: true
                anchors {
            ...
            Button {
                ...
                onClicked: {
                    Scripts.stranslate(text.text, from.selectedIndex, dest.selectedIndex);
                }
            }

            TextArea {
                id: translateRes
                text: "<i>Translation</i>"
